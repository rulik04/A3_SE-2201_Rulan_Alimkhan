...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:55810579@localhost/greenlight?sslmode=disable", "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "68ac8fb162d8b6", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "4811fd96bcb986", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <rulik04@mail.ru>", "SMTP sender")
